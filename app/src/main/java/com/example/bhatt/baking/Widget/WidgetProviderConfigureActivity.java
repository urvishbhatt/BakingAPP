...
public class WidgetProviderConfigureActivity extends Activity {
    ...
    private static final String PREFS_NAME = "com.example.bhatt.listwidget2.WidgetProvider";
    ...
    View.OnClickListener mOnClickListener = new View.OnClickListener() {
        public void onClick(View v) {
            ...
            switch (name){
                case "Nutella Pie" : JSONID = 0;
                    break;
                case "Brownies" : JSONID = 1;
                    break;
                case "Yellow Cake" : JSONID = 2;
                    break;
                case "Cheesecake" : JSONID = 3;
                    break;
            }
